    ...
    ElevatedCard(
        ...
        Row(
            ...
            if (DhizukuApi.isPermissionGranted) {
                ...
                Icon(Icons.Outlined.CheckCircle, "Dhizuku Available")

                Column(Modifier.padding(start = 20.dp)) {

                    Text(
                        text = "Dhizuku Available",
                        fontFamily = FontFamily.Serif,
                        style = MaterialTheme.typography.titleMedium
                    )
                ...
                Icon(Icons.Outlined.Warning, "Dhizuku Unavailable")

                Column(Modifier.padding(start = 20.dp)) {

                    Text(
                        text = "Dhizuku Unavailable",
                        fontFamily = FontFamily.Serif,
                        style = MaterialTheme.typography.titleMedium
                    )
...
private fun InfoCard() {
    ...
    ElevatedCard {
        ...
        Column(
            ...
            infoCardContent(
                stringResource(R.string.home_lspatch_version) to
            ...
            infoCardContent(
                stringResource(R.string.home_framework_version) to
                        LSPConfig.instance.CORE_VERSION_NAME + " (${LSPConfig.instance.CORE_VERSION_CODE})"
            )
